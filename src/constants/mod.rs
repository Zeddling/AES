pub const HEX_LETTERS: [&str; 6] = ["a", "b", "c", "d", "e", "f"];

pub const RCON: [&str; 10] = ["01", "02", "04", "08", "10", "20", "40", "80", "1b", "36"];

pub const SBOX: [[&str; 16]; 16] = [
    [
...
pub const INV_SBOX_MATRIX: [[&str; 16]; 16] = [
    [
...
pub const MIX_COLUMNS_MATRIX: [[&str; 4]; 4] = [
    ["02", "03", "01", "01"],
    ["01", "02", "03", "01"],
    ["01", "01", "02", "03"],
    ["03", "01", "01", "02"],
...
pub const INV_MIX_COLUMNS_MATRIX: [[&str; 4]; 4] = [
    ["0e", "0b", "0d", "09"],
    ["09", "0e", "0b", "0d"],
    ["0d", "09", "0e", "0b"],
    ["0b", "0d", "09", "0e"],
...
pub const NINE: &str = "09";
pub const ELEVEN: &str = "0b";
pub const THIRTEEN: &str = "0d";
